...
-- renamed them away.
--
-- 2026-08 ADDENDUM (migration 129, beads): both provider CHECKs below were
...
-- that, by then, may already hold a 'beads' row (from migration 129, which
...
-- 129's own CHECK (the final widening) is unaffected and remains the

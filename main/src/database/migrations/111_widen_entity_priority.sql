-- Migration 111: widen the entity `priority` CHECK on ideas/epics/tasks from
...
ALTER TABLE ideas ADD COLUMN priority_widen_111 TEXT;
UPDATE ideas SET priority_widen_111 = priority;
ALTER TABLE ideas DROP COLUMN priority;
ALTER TABLE ideas
  ADD COLUMN priority TEXT NOT NULL DEFAULT 'P2'
    CHECK (priority IN ('P0','P1','P2','P3','P4','P5','P6'));
UPDATE ideas SET priority = COALESCE(priority_widen_111, 'P2');
ALTER TABLE ideas DROP COLUMN priority_widen_111;

-- ---------------------------------------------------------------------------
-- epics.priority
-- ---------------------------------------------------------------------------

ALTER TABLE epics ADD COLUMN priority_widen_111 TEXT;
UPDATE epics SET priority_widen_111 = priority;
ALTER TABLE epics DROP COLUMN priority;
ALTER TABLE epics
  ADD COLUMN priority TEXT NOT NULL DEFAULT 'P2'
    CHECK (priority IN ('P0','P1','P2','P3','P4','P5','P6'));
UPDATE epics SET priority = COALESCE(priority_widen_111, 'P2');
ALTER TABLE epics DROP COLUMN priority_widen_111;

-- ---------------------------------------------------------------------------
-- tasks.priority
-- ---------------------------------------------------------------------------

ALTER TABLE tasks ADD COLUMN priority_widen_111 TEXT;
UPDATE tasks SET priority_widen_111 = priority;
ALTER TABLE tasks DROP COLUMN priority;
ALTER TABLE tasks
  ADD COLUMN priority TEXT NOT NULL DEFAULT 'P2'
    CHECK (priority IN ('P0','P1','P2','P3','P4','P5','P6'));
UPDATE tasks SET priority = COALESCE(priority_widen_111, 'P2');
ALTER TABLE tasks DROP COLUMN priority_widen_111;

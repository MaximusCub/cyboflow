...
export class OmpPtyManager extends AbstractCliManager {
  ...
  // — a session can host several OMP PTY panels (Add-chat), and the scan form
  // deleted panelRunIds/ptyBacklog for EVERY panel in the session, including a
  // still-live sibling whose process had not exited.
